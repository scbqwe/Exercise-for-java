package scb.task;
	...
	public class ConnDB {
		...
		private static Properties prop = new Properties(); // 创建并实例化Properties对象的实例
				...
				//连接数据库的URL地址
				private static String url="jdbc:sqlserver://localhost:1433;DatabaseName=WebDB"; 
				//数据库的用户名
				private static final String username="sa";
				//数据库的密码
				private static final String password="banma.scb";
				...
				public ConnDB() { // 构造方法
					try { // 捕捉异常
						...
						driver = prop.getProperty("DB_CLASS_NAME"); // 获取数据库驱动
						// 获取连接的URL
